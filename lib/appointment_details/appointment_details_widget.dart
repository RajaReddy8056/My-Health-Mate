...
import '../hospital_detail_page/hospital_detail_page_widget.dart';
                  ...
                  child: Padding(
                    ...
                    child: StreamBuilder<HospitalsLocationRecord>(
                      stream: HospitalsLocationRecord.getDocument(
                          appointmentDetailsAppointmentsRecord.hospitalRef!),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                        if (!snapshot.hasData) {
                          return Center(
                        ...
                        return InkWell(
                          onTap: () async {
                            await Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => HospitalDetailPageWidget(
                                  hospitalref: containerHospitalsLocationRecord
                                      .reference,
                                ),
                              ),
                            );
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          '${containerHospitalsLocationRecord.hospitalSpeciality} Speacialist',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyText1
                                              .override(
                                                fontFamily: 'Outfit',
