...
part of 'appointment_hospital_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<AppointmentHospitalRecord> _$appointmentHospitalRecordSerializer =
    new _$AppointmentHospitalRecordSerializer();

class _$AppointmentHospitalRecordSerializer
    implements StructuredSerializer<AppointmentHospitalRecord> {
  @override
  ...
  @override
  final String wireName = 'AppointmentHospitalRecord';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, AppointmentHospitalRecord object,
  ...
  @override
  AppointmentHospitalRecord deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new AppointmentHospitalRecordBuilder();
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'appointmentEmail':
          ...
          break;
        case 'hospital_ref':
          result.hospitalRef = serializers.deserialize(value,
              specifiedType: const FullType(DocumentReference, const [
                const FullType.nullable(Object)
              ])) as DocumentReference<Object?>?;
          break;
...
class _$AppointmentHospitalRecord extends AppointmentHospitalRecord {
  @override
  ...
  @override
  final DocumentReference<Object?>? hospitalRef;
  @override
  final DocumentReference<Object?>? patient;
  @override
  final String? patientName;
  @override
  final DocumentReference<Object?>? ffRef;

  factory _$AppointmentHospitalRecord(
          [void Function(AppointmentHospitalRecordBuilder)? updates]) =>
      (new AppointmentHospitalRecordBuilder()..update(updates))._build();

  _$AppointmentHospitalRecord._(
  ...
  @override
  AppointmentHospitalRecord rebuild(
          void Function(AppointmentHospitalRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  AppointmentHospitalRecordBuilder toBuilder() =>
      new AppointmentHospitalRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is AppointmentHospitalRecord &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'AppointmentHospitalRecord')
...
class AppointmentHospitalRecordBuilder
    implements
        Builder<AppointmentHospitalRecord, AppointmentHospitalRecordBuilder> {
  _$AppointmentHospitalRecord? _$v;
  ...
  DocumentReference<Object?>? _hospitalRef;
  DocumentReference<Object?>? get hospitalRef => _$this._hospitalRef;
  set hospitalRef(DocumentReference<Object?>? hospitalRef) =>
      _$this._hospitalRef = hospitalRef;

  DocumentReference<Object?>? _patient;
  DocumentReference<Object?>? get patient => _$this._patient;
  set patient(DocumentReference<Object?>? patient) => _$this._patient = patient;
  ...
  AppointmentHospitalRecordBuilder() {
    AppointmentHospitalRecord._initializeBuilder(this);
  }

  AppointmentHospitalRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(AppointmentHospitalRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$AppointmentHospitalRecord;
  }

  @override
  void update(void Function(AppointmentHospitalRecordBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  AppointmentHospitalRecord build() => _build();

  _$AppointmentHospitalRecord _build() {
    final _$result = _$v ??
        new _$AppointmentHospitalRecord._(
