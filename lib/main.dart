...
class _MyAppState extends State<MyApp> {
  ...
  late Stream<MyhealthmateFirebaseUser> userStream;
  MyhealthmateFirebaseUser? initialUser;
  ...
  void initState() {
    super.initState();
    userStream = myhealthmateFirebaseUserStream()
...
class _NavBarPageState extends State<NavBarPage> {
  ...
  Widget build(BuildContext context) {
    final tabs = {
      ...
      'Community_page': CommunityPageWidget(),
